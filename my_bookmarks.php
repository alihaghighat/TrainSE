                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    <div class="courses-one--courses__menu-box">
                        <ul class="project-filter clearfix post-filter has-dynamic-filters-counter list-unstyled">
                            <li data-filter=".filter-item" class="active"><span class="filter-text">My bookmarks</span></li>
...
if (isset($_GET['field'])) {
    ...
    $allCourses = select(QUERY_FETCH_BOOKMARKS, "s", [$_SESSION['user']]);
}
